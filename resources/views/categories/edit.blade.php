                ...
                <div class="card card-custom bg-white">
                    ...
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center"
                        ...
                        <h5 class="m-0 font-weight-bold" style="color: #2c3e50;">
                            <i class="fa fa-pencil-square-o mr-2 text-warning"></i> Edit Produk: {{ $category->name }}
                        </h5>
                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            ...
                            <div class="col-lg-8 pr-lg-5 border-right">
                                ...
                                <div class="row">
                                    {{-- 2. JENIS KATEGORI (GROUP) --}}
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label class="font-weight-bold text-dark small text-uppercase">Jenis Kategori
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="group"
                                                class="form-control {{ $errors->first('group') ? 'is-invalid' : '' }}"
                                                value="{{ old('group', $category->group) }}"
                                                placeholder="Contoh: Material, Cat, Pipa" required>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" name="stock"
                                        ...
                                        value="{{ old('stock', $category->stock) }}" min="0">
                            ...
                            <div class="col-lg-4 pl-lg-4 mt-4 mt-lg-0">
                                <div class="form-group text-center">
                                    ...
                                    <div class="mb-3 p-1 border rounded bg-white shadow-sm d-flex align-items-center justify-content-center"
                                        ...
                                        @if ($category->image)
                                            <img src="{{ asset('category_image/' . $category->image) }}" alt="Preview"
