        ...
        <div class="col-md-12">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <form action="{{ route('categories.index') }}" method="GET" class="form-inline justify-content-end">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control" placeholder="Cari Kode atau ..." 
                            ...
                            <tbody>
                                @forelse ($categories as $index => $category)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="badge badge-info">{{ $category->group ?? 'Umum' }}</span>
                                        </td>

                                        <td class="align-middle">
                                            <span
                                                class="badge {{ ($category->stock ?? 0) > 0 ? 'badge-success' : 'badge-danger' }}">
                                                {{ $category->stock }}
                                            </span>
                                        </td>
