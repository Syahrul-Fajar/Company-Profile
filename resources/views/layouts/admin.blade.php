...
<body>
    <aside id="left-panel" class="left-panel">
        <div class="sidebar-header-box">
            <a href="{{ url('admin/dashboard') }}" class="sidebar-brand-text">
                <i class="fa fa-cube" style="color: #f39c12; margin-right: 10px;"></i>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="desktop-logo-container">
                <a href="{{ url('admin/dashboard') }}" class="mobile-brand-text">
                    <i class="fa fa-cube" style="color: #f39c12; margin-right: 10px;"></i>
                    AdminPanel
                </a>
            </div>
                ...
                <div class="header-menu">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="#" onclick="logout(event)"><i class="fa fa-power-off"></i>
                                Logout</a>
                        </div>
                    </div>
                </div>
            ...
            <ul class="mobile-nav-bar">
                <li>
                    <a href="{{ url('admin/dashboard') }}"
                        class="mobile-nav-item {{ Request::is('admin/dashboard*') ? 'active' : '' }}">
                        <i class="fa fa-laptop"></i> <span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('admin/categories') }}"
                        class="mobile-nav-item {{ Request::is('admin/categories*') ? 'active' : '' }}">
                        <i class="fa fa-list-ul"></i> <span>Kategori</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('admin/abouts') }}"
                        class="mobile-nav-item {{ Request::is('admin/abouts*') ? 'active' : '' }}">
                        <i class="fa fa-info-circle"></i> <span>Tentang</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="logout(event)" class="mobile-nav-item">
                        @if (Auth::user()->avatar)
                            <img src="{{ asset('storage/avatars/' . Auth::user()->avatar) }}" class="mobile-profile-img"
                                alt="Profil">
                        @else
                            <img src="{{ asset('ElaAdmin/images/admin.jpg') }}" class="mobile-profile-img"
                                alt="Profil">
                        @endif
