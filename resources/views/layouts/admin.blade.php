    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <ul class="mobile-nav-bar">
                ...
                <li>
                    <a href="{{ url('admin/products') }}"
                        class="mobile-nav-item {{ Request::is('admin/products*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('admin.settings') }}"
                        class="mobile-nav-item {{ Request::is('admin/settings*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="#" onclick="logout(event)" class="mobile-nav-item">
                        @if (Auth::user()->avatar)
                            <img src="{{ asset('avatars/' . Auth::user()->avatar) }}" class="mobile-profile-img"
                                alt="Profil">
                        @else
