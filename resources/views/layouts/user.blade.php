    ...
    <header id="header">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                {{-- Logo Teks dengan Link ke Hero --}}
                <h1><a href="{{ url('/') }}#hero">TOKO BANGUNAN JAYA</a></h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 mb-5">
                    <div class="d-flex align-items-center mb-4">
                        {{-- Icon Logo Kotak Orange --}}
                        <div
                            style="background: #f0ad4e; width: 45px; height: 45px; border-radius: 8px; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    ...
                    <ul class="list-unstyled" style="color: #a0a6b5; font-size: 0.95rem;">
                        ...
                        <li class="mb-3 d-flex">
                            ...
                            <span>
                                (021) 1234-5678<br>
                                <span class="text-white">0812-3456-7890 (WhatsApp)</span>
                            </span>
                        </li>
                        <li class="mb-3 d-flex">
