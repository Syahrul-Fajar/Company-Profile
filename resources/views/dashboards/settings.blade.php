                    ...
                    <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                        <div class="card-body text-center p-5">
                            <div class="mb-3 position-relative d-inline-block">
                                {{-- Preview Foto --}}
                                @if(Auth::user()->avatar)
                                    <img src="{{ asset('storage/avatars/'.Auth::user()->avatar) }}" class="rounded-circle border" style="width: 120px; height: 120px; object-fit: cover; border: 4px solid #f39c12 !important;">
                                @else
                                    <img src="{{ asset('ElaAdmin/images/admin.jpg') }}" class="rounded-circle border" style="width: 120px; height: 120px; object-fit: cover; border: 4px solid #f39c12 !important;">
                                @endif
