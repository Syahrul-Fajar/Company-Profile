        ...
        <div class="row">
            <div class="col-lg-8 col-md-10">
                ...
                <div class="hero-btns wow fadeInUp" data-wow-delay="0.4s">
                    <a href="https://wa.me/628123456789" target="_blank" class="btn-custom btn-orange">
            ...
            <div class="row">
                ...
                @foreach ($categories as $groupName => $items)
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay="{{ $loop->index * 0.1 }}s">
                        <a href="{{ url('category/' . $firstItem->id) }}" style="text-decoration: none;">
                            <div class="product-card h-100">
                                <div class="product-img-wrapper">
                                    {{-- Foto Perwakilan --}}
                                    <img src="{{ asset('category_image/' . $firstItem->image) }}" alt="{{ $groupName }}"
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0 wow fadeInLeft">
                        <div class="about-img-box">
                            ...
                            <img src="{{ asset('about_image/' . $about->image) }}" alt="Tentang Toko"
                                class="img-fluid rounded shadow-lg w-100" style="object-fit: cover; min-height: 350px;"
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    ...
                    <a class="btn btn-lg shadow rounded-pill px-5 font-weight-bold" href="https://wa.me/628123456789"
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp">
                    <div class="contact-box">
                        ...
                        <p class="text-muted">+62 812 3456 7890<br>(024) 1234 567</p>
                    </div>
                </div>
