                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card">
                        <div class="product-img-wrapper">
                            @if ($item->stock > 0)
                                <span class="stock-badge bg-ready">Ready</span>
                            @else
                                <span class="stock-badge bg-empty">Habis</span>
                            @endif

                            <img src="{{ asset('category_image/' . $item->image) }}" alt="{{ $item->name }}"
                                class="product-img"
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://wa.me/628123456789?text=Halo%20Admin,%20saya%20tertarik%20produk%20{{ $item->name }}%20({{ $item->code }})"
